...
- World books: shared contract `app/sharedCore/src/main/kotlin/com/example/chatbar/data/local/entity/WorldBook.kt`; authoritative pure runtime `app/sharedCore/src/main/kotlin/com/example/chatbar/domain/worldbook/WorldBookEngine.kt` and `WorldBookScanContext.kt`; request-level source/planner orchestration currently remains in Android `ui/chat/ChatViewModel.kt` until Phase 4B2. Editing remains ui/worldbook/WorldBookEditScreen.kt and WorldBookEditViewModel.kt. For AI creation, blank-content fill, research, candidates, apply, or resume, use chatbar-worldbook-ai.
