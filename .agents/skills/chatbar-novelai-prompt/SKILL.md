...
- `NOVELAI_IMAGE_NATURAL_LANGUAGE_PROMPT_SYSTEM_V5` is the one dedicated feature-mode exception: studio AI-design natural-language mode uses Chinese base/role prose, preserves English character tags, `source#`/`target#`/`mutual#` interaction syntax, NAI weights, structured JSON, and V5 1000/150-token budgets. Keep it V5-only and route through `novelAiImageNaturalLanguagePromptCoreSystem`.
