...
- Studio live completion keeps its 250ms UI debounce, cancellation, max-eight candidates, and nonblocking failure state outside prompt text. Search categories remain general/copyright/character; rank exact, prefix, contains, then `post_count` and stable name order.
